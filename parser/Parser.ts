    ...
    while (index < lines.length) {
        ...
        if (lineUpper.startsWith("TAD")) {
            ...
            if (enTad) {
                ...
                report?.addMark(
                    "warning",
                    `No se esperaba el inicio de un TAD. Te olvidaste de un "FIN TAD"?`,
                    offset,
                    line.length
                );
            ...
            if (section === "none") {
                if (lastSection === "none") {
                    ...
                    lastSection === "axiomas" ||
                    lastSection === "observadores" ||
                    lastSection === "generadores" ||
                    lastSection === "otras operaciones"
                ) {
                    ...
                    if (split.length === 1) {
                        ...
                        if (lastSection === "axiomas") {
                            ...
                            report?.addMark(
                                "error",
                                "Se esperaba la definición de una operación.",
                                offset,
                                line.length
                            );
                        }
                        ...
                        if (lastSection === "axiomas") {
                            ...
                            const op: Operacion | null = parseOperacion(
                                source.substring(leftOffset, offset),
                                lastSection,
                                report
                            );
                ...
                if (section === "generos") {
                    ...
                    if (lines[index - 1].match(paramRegex)) {
                        ...
                        if (tad.genero.length > 0) {
                            report?.addMark(
                                "warning",
                                "Este TAD ya tenía géneros. Esta línea será ignorada.",
                                offset,
                                line.length
                            );
                        } else {
